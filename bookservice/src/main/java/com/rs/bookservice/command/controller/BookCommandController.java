package com.rs.bookservice.command.controller;
...
import com.rs.bookservice.command.model.BookRequestModel;
...
public class BookCommandController {
    ...
    public String addBook(@RequestBody BookRequestModel model)
    {
        ...
        commandGateway.sendAndWait(command); // send command add book
        return "added Book";
    }
